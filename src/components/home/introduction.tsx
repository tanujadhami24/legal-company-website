...
export default function Introduction() {
  return (
    <section className="py-20 bg-slate-50/40 dark:bg-slate-900/10 border-b border-amber-500/10 relative overflow-hidden text-center">
      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10 space-y-6">
        ...
        <p className="text-slate-700 dark:text-slate-350 text-base md:text-lg leading-relaxed font-light">
